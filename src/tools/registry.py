...
class Registry:
    ...
    async def call_tool(self, name: str, arguments: dict[str, Any], context: dict[str, Any]) -> Any:
        ...
        if self.connections.get(connection, None):
            return await self.connections[connection].call_action(action, arguments, context)
